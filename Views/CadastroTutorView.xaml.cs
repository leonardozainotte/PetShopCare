        ...
        private void CpfTextBox_TextChanged(object sender, TextChangedEventArgs e) {
            if (sender is TextBox textBox) {
                ...
                if (apenasNumeros.Length >= 10)
                    formatado = $"{apenasNumeros.Substring(0, 3)}.{apenasNumeros.Substring(3, 3)}.{apenasNumeros.Substring(6, 3)}-{apenasNumeros.Substring(9)}";
                else if (apenasNumeros.Length >= 7)
                    formatado = $"{apenasNumeros.Substring(0, 3)}.{apenasNumeros.Substring(3, 3)}.{apenasNumeros.Substring(6)}";
                else if (apenasNumeros.Length >= 4)
                    formatado = $"{apenasNumeros.Substring(0, 3)}.{apenasNumeros.Substring(3)}";
